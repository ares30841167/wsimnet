...
def main(args: argparse.Namespace) -> None:
    ...
    for i in range(1, args.fold + 1):
        ...
        loss_values = [item["train_loss"] for item in m]
    ...
    fig.write_html(f'{args.export_path}/{args.model}_loss.html')
    fig.write_image(f'{args.export_path}/png/{args.model}_loss.png', width=960, height=720, scale=3)
